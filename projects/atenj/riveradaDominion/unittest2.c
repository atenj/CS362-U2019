...
int main(){
    ...
    printf("\n");
    printf("=========================================\n");
    printf("Unit Test 2: Minion - int callMinion()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printf("Calling callMinion(1, 0, &testState, 3, 0)\n");
#endif
    callMinion(0, choice1, choice2, &testState, 3);
#if (NOISY_TEST == 1)
    printHand(0, &testState);
    printf("\n");
#endif
    ...
    printHand(0, &testState);
    printf("Calling callMinion(0, 1, &testState, 3, 0)\n");
#endif
    callMinion(0, choice1, choice2, &testState, 3);
#if (NOISY_TEST == 1)
    printHand(0, &testState);
