...
int main() {
    ...
    printf("\n");  
    printf("=========================================\n");
    printf("Unit Test 5: Mine - int cardMine()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printHand(0, &state);
    printf("Calling cardMine(0, 5, state, 3, 0)\n");
#endif
    choice1 = 0;
    choice2 = 5;
    handPos = 3;
    currentPlayer = 0;
    cardMine(choice1, choice2, &testState, handPos, currentPlayer);
#if (NOISY_TEST == 1)
    ...
    printHand(0, &state);
    printf("Calling cardMine(0, 200, state, 3, 0)\n");
#endif
    choice1 = 0;
    choice2 = 200;
    handPos = 3;
    ...
    printf("\n");
#if (NOISY_TEXT ==1)
    printf("Calling cardMine(0, -1, state, 3, 0)\n");
#endif
    choice1 = 0;
    choice2 = -1;
    handPos = 3;
    ...
    printHand(0, &state);
    printf("Calling cardMine(4, gold, state, 0, 0)\n");
#endif
    choice1 = 4;
    choice2 = 6;
    handPos = 0;
    currentPlayer = 0;
    printf("Test 13: ");
    assertTrue((cardMine(choice1, choice2, &testState, handPos, currentPlayer)), -1);
    printf("\n");
    printf("\n");
    return 0;
}