...
int main(){
    ...
    printf("\n");
    printf("=========================================\n");   
    printf("Unit Test 3: Ambassador - int cardAmbassador()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printf("Calling cardAmbassador(choice1, choice2, &testState, handPos, currentPlayer)\n");
#endif
    ...
    printf("Test 1: ");
    assertTrue(cardAmbassador(choice1, choice2, &testState, handPos, currentPlayer), -1);
#if (NOISY_TEST == 1)    
...
//Case #4: Inputs Within Bounds, playing ambassador at 2, revealing copper at 0
    ...
    choice2 = 2; //return 2 copies to supply
    handPos = 2; //position of Ambassador card we want to play
    cardAmbassador(choice1, choice2, &testState, handPos, currentPlayer);
    printf("Test 4: ");
