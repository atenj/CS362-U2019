...
int main(){
    ...
    printf("\n");
    printf("=========================================\n");
    printf("Unit Test 1: Baron - int cardBaron()\n");
    printf("=========================================\n");
    printf("\n");
    ...
    printf("Calling cardBaron(1, &testState, 0)\n");
#endif
    choice1 = 1;
    cardBaron(choice1, &testState, currPlayer);
#if (NOISY_TEST == 1)
    printHand(currPlayer, &testState);
    printf("\n");
#endif
    ...
    printHand(0, &state);
    printf("Calling cardBaron(0, &testState, 0)\n");
#endif
    choice1 = 0;
    cardBaron(choice1, &testState, currPlayer);
#if (NOISY_TEST == 1)
